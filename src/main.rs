...
async fn main() {
    ...
    let server = match HttpServer::new(move || {
        App::new()
            ...
            .service(routes::add_member)
            .service(routes::add_attendance)
            .service(routes::add_invoice)
            .service(routes::add_payment)
            .service(routes::add_event)
            .service(routes::add_period)
            .service(routes::get_member)
            .service(routes::get_attendance)
            .service(routes::get_invoice)
            .service(routes::get_payment)
            .service(routes::get_event)
            .service(routes::get_period)
    })
    .bind(server_addr)
    {
        Ok(s) => {
